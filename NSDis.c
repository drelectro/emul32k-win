   ...
   if (Function < InstructionCount)
   {
      ...
      switch (Function)
      {
         case Scond:
         {
            ...
            sprintf_s(Str, sizeof(Str), "S%s", &InstuctionText[Condition][1]);             // Offset by 1 to lose the 'B'
         }
         break;
         ...
         default:
         {
             sprintf_s(Str, sizeof(Str), "%s", InstuctionText[Function]);
         }
      }
      ...
      if (OperandSize)
      {
         ...
         if (Format >= 9)
         {
             sprintf_s(Str + strlen(Str), sizeof(Str) - strlen(Str), "%c", PostFltLk[OperandSize & 3]);                 // Offset by 1 to loose the 'B'
         }
         else
         {
             sprintf_s(Str + strlen(Str), sizeof(Str) - strlen(Str), "%c", PostFixLk[OperandSize & 3]);                 // Offset by 1 to loose the 'B'
         }
      }
      ...
      switch (Function)
      {
         ...
         case MOVZiW:
         {
             sprintf_s(Str + strlen(Str), sizeof(Str) - strlen(Str), "W");
         }
         break;
         ...
         case MOVXiD:
         {
             sprintf_s(Str + strlen(Str), sizeof(Str) - strlen(Str), "D");
         }
         break;
      }
